...
export default function Pricing({ onSelectPlan }: PricingProps) {
  ...
  const monthlyPlans = [
    ...
    },
    {
      ...
      price: "5 000",
      numPrice: 5000,
      badge: "Particuliers & Foyers · 6 pers.",
      period: "FCFA / mois (par foyer)",
      subNote: "Jusqu'à 6 personnes · Gratuit pour les enfants < 12 ans",
      desc: "Idéal pour veiller sur la santé de votre foyer à Dabou : jusqu'à 6 personnes couvertes, et gratuit pour les enfants de moins de 12 ans de la famille.",
      features: [
        "Jusqu'à 6 personnes incluses par foyer",
        "Gratuit pour les enfants de moins de 12 ans de la famille",
        "1 visite à domicile par semaine pour la famille (samedi ou dimanche)",
  ...
  const annualPlans = [
    ...
    },
    {
      ...
      numPrice: 50000,
      oldPrice: "60 000",
      badge: "Recommandé · 6 pers. & Gratuit < 12 ans",
      period: "FCFA / an (par foyer)",
      subNote: "Jusqu'à 6 personnes · Gratuit pour les enfants < 12 ans",
      desc: "La formule sérénité totale pour votre famille à Dabou pendant 12 mois complets : jusqu'à 6 personnes incluses et gratuité pour les enfants de moins de 12 ans.",
      features: [
        "Jusqu'à 6 personnes incluses par foyer",
        "Gratuit pour les enfants de moins de 12 ans de la famille",
        "52 visites familiales à domicile (chaque week-end)",
        "Suivi médical et prise des constantes vitales pour chaque membre",
